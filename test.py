...
model = Sequential()
model.add(Dense(512, activation='leaky_relu', input_shape=(input_data.shape[1],), kernel_regularizer=l2(0.001)))
...
# Train the model
history = model.fit(in_train, out_train, epochs=260, batch_size=64, validation_data=(in_test, out_test), 
